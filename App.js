...
function MyFooterTabs() {
  return (
    ...
    >
      <Tab.Screen name="HomeFooter" component={MyDrawer} style={styles.FooterText} options={{header:()=>null,tabBarLabel: 'Home' }}/>
...
//   //       options={{header:()=>null,
//   //         tabBarLabel: 'Home',
//   //         tabBarIcon: () => <MaterialCommunityIcons name="home" style={{fontSize:30,color:'#ffffff'}}></MaterialCommunityIcons>
//   //       }}
//   //       >
//   //       </Top.Screen>
...
function MyDrawer({navigation}){
  return (
    ...
    screenOptions={{
      ...
      headerStyle:{backgroundColor:'#191820',elevation:0,shadowOpacity:0},
      headerTintColor:'#fff',
      headerTitleStyle:{
        fontSize:25,
      }
...
function App() {
  return (
    ...
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen name="MainHome" component={MyFooterTabs}  options={{header:()=>null}}/>
